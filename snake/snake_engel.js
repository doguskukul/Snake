...
var hız=60, c, cc, yilan, engel_1, engel_2, engel_3, engel_4, elma, grid, skor, yeniskor, kafa, yenikafa, d, paused, yemsesi, gameoversesi,patternkafa,patterngovde,patterncount,patternengel,image_c=1;
/* 
c : canvas nesnesi
...
class game {
    ...
    constructor(w,h){
        ...
        cc = c.getContext("2d");
        engel_1 = c.getContext("2d");
        engel_2 = c.getContext("2d");
        engel_3 = c.getContext("2d");
        engel_4 = c.getContext("2d");
    ...
    update(){
        ...
        if(kafa.x == 140 & kafa.y == 140){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 175 & kafa.y == 175){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 210 & kafa.y == 140){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 245 & kafa.y == 140){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 420 & kafa.y == 420){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 420 & kafa.y == 455){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 420 & kafa.y == 490){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 420 & kafa.y == 525){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 455 & kafa.y == 245){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 490 & kafa.y == 245){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 525 & kafa.y == 280){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 560 & kafa.y == 280){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 525 & kafa.y == 70){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 525 & kafa.y == 105){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 525 & kafa.y == 140){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 525 & kafa.y == 175){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 35 & kafa.y == 665){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 35 & kafa.y == 630){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 35 & kafa.y == 595){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 35 & kafa.y == 560){
            gameoversesi.play();
            this.stop();
        }
        if(kafa.x == 35 & kafa.y == 525){
            gameoversesi.play();
            this.stop();
        }
    ...
    draw(){
        ...
        //engel çizme
        var resimengel = new Image();
        resimengel.src="images/TAS.png";
        patternengel = cc.createPattern(resimengel, "repeat"); 
        engel_1.fillStyle=patternengel;
        engel_1.fillRect(140,140,grid *4,grid);
        
        engel_2.fillStyle=patternengel;
        engel_2.fillRect(420,420,grid,grid*4);

        engel_3.fillStyle=patternengel;
        engel_3.fillRect(455,280,grid*4,grid);

        engel_2.fillStyle=patternengel;
        engel_2.fillRect(525,70,grid,grid*3);

        engel_2.fillStyle=patternengel;
        engel_2.fillRect(35,525,grid,grid*5);
